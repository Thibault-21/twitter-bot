 # ligne très importante qui appelle la gem. #!!!!!!!!!!!!!!!!! .gitignore
 require 'twitter'
  require 'dotenv'
...
#créer mon array dans laquelle je vais choisir 5 adresses de journalistes a qui je vais envoyé un tweet 
